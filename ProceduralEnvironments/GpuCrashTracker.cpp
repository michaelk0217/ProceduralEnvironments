...
void GpuCrashTracker::Initialize(bool appUsesStrippedShaders)
{
	m_shaderDatabase.Initialize(appUsesStrippedShaders);
...
void GpuCrashTracker::OnDescription(PFN_GFSDK_Aftermath_AddGpuCrashDumpDescription addDescription)
{
    ...
    addDescription(GFSDK_Aftermath_GpuCrashDumpDescriptionKey_ApplicationName, "NsightAftermath");
